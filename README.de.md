...
* **Mehrere Mannschaften eines Vereins** lassen sich abdecken, sofern sie bei
  OpenLigaDB dieselbe Team-Nummer tragen — dann genügt es, ihr Ligakürzel in
  `league_shortcuts` zu ergänzen. Spielen an einem Tag beide, kann eine
...
[CheatSheet](CHEATSHEET-matchday.de.md).
...
stehen in **[CHEATSHEET-matchday.de.md](CHEATSHEET-matchday.de.md)**.
...
| Datei | Inhalt |
|---|---|
| `README.de.md` | dieses Dokument (englisch: `README.md`) |
...
| `skyrelay_common.py` | gemeinsame Bausteine beider Programme (Protokoll, Bilder, Video-Upload) |
| `skyrelay_config.py` | Konfiguration prüfen, anzeigen, nachziehen |
| `skyrelay_layout.py` | Aufbau der Beiträge, Zeichenzählung, Aufteilen |
| `skyrelay_i18n.py` | Übersetzungen der Bedienoberfläche |
| `tools/i18n.sh` | Kataloge erzeugen, angleichen, übersetzen |
| `skyrelay-testlauf.py` | spielt echte Kanal-Nachrichten durch die Ticker-Pipeline, ohne zu veröffentlichen |
| `CHEATSHEET-matchday.de.md` | alle Umgebungsvariablen, Betriebsarten, Dateien, Fehlerbehebung (englisch: `CHEATSHEET-matchday.md`) |
